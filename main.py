...
class Launcher:
    ...
    theme = {
        ...
        "slider": {
            ...
            "::handle:horizontal:hover": {"border-color": "@oscr"},
            "::handle:horizontal:pressed": {"background-color": "#666666"},
        },
        # holds sub-pages
        "tabber": {
            "background": "none",
        ...
        "tree_table": {
            ...
            # down-pointing arrow
            "::branch:open:has-children": {"image": "url(assets/chevron-down.svg)"},
            # right-pointing arrow
            "::branch:closed:has-children": {"image": "url(assets/chevron-right.svg)"},
        },
        ...
        "combobox": {
            ...
            "::drop-down": {"border-style": "none", "padding": (2, 2, 2, 2)},
            "~QAbstractItemView": {
                "background-color": "@mbg",
                "border-style": "solid",
                "border-color": "@bc",
        ...
        # small window
        "dialog_window": {"background-color": "@oscr"},
        ...
        "live_plot_widget": {"font": ("Overpass", 9, "medium")},
        ...
        "splitter": {
            ...
            "margin": 0,
            "padding": 0,
            "::handle": {"background-color": "@oscr"},
            "::handle:pressed": {"background-color": "@bc"},
            "::handle:vertical": {"height": "@bw", "margin": (0, 13, 0, 13)},
        },
    ...
    def launch():
        ...
        exit_code = OSCRUI(
            ...
            args=args,
            path=Launcher.base_path(),
            config=Launcher.app_config(),
            versions=(Launcher.__version__, Launcher.version),
        ).run()
        sys.exit(exit_code)
